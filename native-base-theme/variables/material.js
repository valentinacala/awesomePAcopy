...
export default {
  ...
  // Segment
  segmentBackgroundColor: "#0066CC",
  segmentActiveBackgroundColor: "#fff",
  segmentTextColor: "#fff",
  segmentActiveTextColor: "#0066CC",
  segmentBorderColor: "#fff",
  segmentBorderColorMain: "#0066CC",
